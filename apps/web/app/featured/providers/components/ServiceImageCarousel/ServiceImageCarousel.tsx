...
import { Carousel, CarouselContent, CarouselItem, CarouselNext, CarouselPrevious } from "@furever/ui/components/carousel";
                            ...
                            <div className="relative h-48 overflow-hidden rounded-lg">
                                ...
                                {image.isThumb && (
                                    <div className="absolute left-2 top-2">
                                        <span className="rounded bg-purple-600 px-2 py-1 text-xs font-medium text-white">Main</span>
                                    </div>
                                )}
                            </div>
                        </CarouselItem>
