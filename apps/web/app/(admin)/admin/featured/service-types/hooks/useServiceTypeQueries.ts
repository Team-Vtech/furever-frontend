...
export function useCreateServiceTypeMutation() {
  ...
  return useMutation({
    mutationFn: (data: CreateServiceTypeData) =>
...
export function useUpdateServiceTypeMutation() {
  ...
  return useMutation({
    mutationFn: ({ id, data }: { id: string; data: UpdateServiceTypeData }) =>
...
export function useDeleteServiceTypeMutation() {
  ...
  return useMutation({
    mutationFn: (id: string) => ServiceTypesClient.deleteServiceType(id),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: QUERY_KEYS.serviceTypes });
