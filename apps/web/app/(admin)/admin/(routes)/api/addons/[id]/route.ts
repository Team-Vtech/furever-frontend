...
export async function GET(
  ...
  try {
    const response = await (await server()).get(`/api/admin/addons/${id}`);
...
export async function PUT(
  ...
  try {
    ...
    const response = await (
      await server()
    ).put(`/api/admin/addons/${id}`, validatedData);
    return NextResponse.json(response.data);
  } catch (error) {
...
export async function PATCH(
  ...
  try {
    ...
    const response = await (
      await server()
    ).patch(`/api/admin/addons/${id}`, validatedData);
    return NextResponse.json(response.data);
  } catch (error) {
    if (error instanceof z.ZodError) {
      return ValidationError(error);
...
export async function DELETE(
  ...
  const { id } = await params;
  try {
    const response = await (await server()).delete(`/api/admin/addons/${id}`);
    return NextResponse.json(response.data);
  } catch (error) {
