...
import { ChevronRight, Edit2, Pause, Plus, Trash2 } from "lucide-react";
                        ...
                        <CardContent className="p-4">
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center gap-2">
                                    <div className={cn("h-2 w-2 rounded-full", service.status === "available" ? "bg-green-500" : "bg-red-500")} />
                                    <span className="text-muted-foreground text-sm capitalize">{service.status}</span>
                                </div>
