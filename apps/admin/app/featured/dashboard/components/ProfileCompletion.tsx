...
export function ProfileCompletion({ className }: ProfileCompletionProps) {
    ...
    return (
        <Card className={cn("border-purple-100 bg-purple-50", className)}>
            <CardContent className="p-6">
                <div className="flex items-start justify-between">
                    <div className="space-y-2">
                        <h3 className="text-2xl font-bold">Welcome back, Dr. Sarah Chen!</h3>
                        <p className="text-muted-foreground">
                            You&apos;re doing great! Complete your profile to unlock more features and connect with more pet parents.
                        </p>
                    ...
                    <Avatar className="h-20 w-20 border-4 border-green-200">
                        ...
                        <AvatarFallback className="bg-green-100 text-green-800">SC</AvatarFallback>
                    </Avatar>
                </div>
            </CardContent>
        </Card>
