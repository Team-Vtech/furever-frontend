...
export function UserForm({ user, onSubmit, isLoading, roles = [], providers = [], isError, error }: UserFormProps) {
    ...
    return (
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
            <div className="space-y-4">
                ...
                <PhoneInput name="phone" required control={control} label="Phone Number" placeholder="Enter phone number" className="mt-1" />
