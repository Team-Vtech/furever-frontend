...
export function BookingEditScreen({ booking, providers }: BookingEditScreenProps) {
    ...
    return (
        ...
        >
            <div className="rounded-lg border border-gray-200 bg-white p-6">
                <BookingForm booking={booking} onSubmit={handleSubmit} isLoading={isUpdating} providers={providers} />
            </div>
        </PageLayout>
    );
}
