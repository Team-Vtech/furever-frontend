...
interface MultiSelectInputProps<TFieldValues extends FieldValues = FieldValues> {
...
function MultiSelectInputComponent<TFieldValues extends FieldValues = FieldValues>({
    control,
    name,
    rules,
    label,
...
export const MultiSelectInput = MultiSelectInputComponent as <TFieldValues extends FieldValues = FieldValues>(
