...
export function ListingErrorState({ resourceName, message, onRetry, action, size = "default" }: ListingErrorStateProps) {
        ...
        <div className={`flex items-center justify-center ${sizeClasses[size]}`}>
            <div className="mx-auto max-w-md space-y-4 text-center">
                ...
                <div className="space-y-2">
                    <h2 className={`font-semibold text-red-600 ${textSizes[size].title}`}>{message || defaultMessage}</h2>
